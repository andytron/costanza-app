...
ActiveRecord::Schema.define(version: 20150403140355) do
  ...
  add_index "comments", ["restroom_id"], name: "index_comments_on_restroom_id", using: :btree
  ...
  add_foreign_key "comments", "restrooms"
